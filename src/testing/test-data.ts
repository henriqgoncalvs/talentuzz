...
// If the data is consumed both in server (SSR or SSG) and client, this method don't because
// you will have a different data in server and client, as the functions are executed in
// different environments.
// If your data is consumed only in client or only in server, you can use this method.
//
// The lib used for generating data was -> @ngneat/falso
//
...
//     const organizationId = randUuid();

//     const populatedAdminUser = {
//       ...user,
//       organizationId,
//       id: randUuid(),
//       createdAt: dateFactory().toISOString(),
//     };

//     const organization = {
//       id: organizationId,
//       createdAt: dateFactory().toISOString(),
//       adminId: populatedAdminUser.id,
//       name: randBrand(),
//       email: randEmail(),
//       phone: randPhoneNumber(),
//       info: randParagraph({ length: 4 }).join('\n'),
//       profileImage: 'https://picsum.photos/200/200',
//     };

//     const jobs = Array.from(Array(5).keys()).map(() => ({
//       id: randUuid(),
//       createdAt: dateFactory().toISOString(),
//       organizationId,
//       position: randJobTitle(),
//       info: randParagraph({ length: 8 }).join('\n'),
//       location: randCountry(),
//       department: randJobArea(),
//     }));

//     data.users.push(populatedAdminUser);
//     data.organizations.push(organization);

//     jobs.forEach((job) => data.jobs.push(job));
//   });

//   return data;
// };

const usersTestData: (AuthUser & { password: string })[] = [
  {
    id: '9f2d1c5b-c510-40e8-9168-8d502e8ffb46',
    createdAt: 1645628972465,
    email: 'admin1@test.com',
    password: 'password',
    organization: {
      id: 'ce9d7818-20ee-45d1-8c0a-1be5f6faf835',
    },
  },
  {
    ...
    password: 'password',
    organization: {
      id: '7160b259-bbec-463b-ae4a-6ad5be387890',
    },
  },
];

const organizationsTestData: Organization[] = [
  {
    id: 'ce9d7818-20ee-45d1-8c0a-1be5f6faf835',
    createdAt: 1645628972465,
    adminId: usersTestData[0].id,
    name: 'Test Org 1',
    email: 'org1@test.com',
    phone: '944-528-1711',
...
const jobsTestData: Job[] = [
  {
    id: 'wS6UeppUQoiXGTzAI6XrM',
    createdAt: 1647070016299,
    organizationId: organizationsTestData[0].id,
  ...
  },
  {
    ...
    organizationId: organizationsTestData[1].id,
    position: 'Software Engineer',
...
export const testData = {
  users: usersTestData,
  organizations: organizationsTestData,
  jobs: jobsTestData,
};
